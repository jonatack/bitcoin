...
`./`               | `anchors.dat`         | Anchor IP address database, created on shutdown and deleted at startup. Anchors are the last known outbound-block-relay peers; an attempt is made to reconnect to them on startup
