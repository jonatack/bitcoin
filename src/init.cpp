...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-blocksonly", strprintf("Whether to reject transactions from network peers, except as part of blocks. Automatic broadcast and rebroadcast of any transactions from inbound peers is disabled, unless the peer has the 'forcerelay' permission. This effectively disables mempool and fee estimation functionality and sets -walletbroadcast=0 if unset. RPC transactions are not affected. For more information refer to the -blocksonly section in doc/reduce-traffic.md. (default: %u)", DEFAULT_BLOCKSONLY), ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
