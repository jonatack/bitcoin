                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {RPCResult::Type::BOOL, "bip152_hb_to", "Whether we selected the peer for (compact blocks) high bandwidth mode"},
                            {RPCResult::Type::BOOL, "bip152_hb_from", "Whether the peer selected us for (compact blocks) high bandwidth mode"},
