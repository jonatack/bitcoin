...
public:
    ...
    void AlreadyHaveTx(int txhash, bool is_wtxid)
    {
        ...
        // Call TxRequestTracker's implementation.
        m_tracker.AlreadyHaveTx(GenTxid{is_wtxid, TXHASHES[txhash]});
    }
        ...
        std::chrono::microseconds reqtime)
    {
        ...
        if (entry.m_state == State::NOTHING) {
            ...
            entry.m_priority = m_tracker.GetPriorityComputer()(TXHASHES[txhash], peer, entry.m_preferred, entry.m_first);
...
void test_one_input(const std::vector<uint8_t>& buffer)
{
    ...
    while (it != buffer.end()) {
        ...
        case 4: // No longer need tx
            ...
            tester.AlreadyHaveTx(txidnum % MAX_TXHASHES, (txidnum / MAX_TXHASHES) & 1);
            break;
