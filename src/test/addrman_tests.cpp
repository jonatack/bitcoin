...
BOOST_AUTO_TEST_CASE(reset_i2p_ports)
{
    ...
    BOOST_CHECK_EQUAL(addresses[0].GetPort(), i2p::sam::PORT_SAM31);
    BOOST_CHECK_EQUAL(addresses[1].ToStringIP(), i2p_new2.ToStringIP());
    BOOST_CHECK_EQUAL(addresses[1].GetPort(), i2p::sam::PORT_SAM31);
    BOOST_CHECK_EQUAL(addresses[2].ToStringIP(), i2p_tried3.ToStringIP());
    BOOST_CHECK_EQUAL(addresses[2].GetPort(), i2p::sam::PORT_SAM31);
    BOOST_CHECK_EQUAL(addresses[3].ToStringIP(), i2p_tried1.ToStringIP());
    BOOST_CHECK_EQUAL(addresses[3].GetPort(), i2p::sam::PORT_SAM31);
    BOOST_CHECK_EQUAL(addresses[4].ToStringIP(), i2p_tried2.ToStringIP());
    BOOST_CHECK_EQUAL(addresses[4].GetPort(), i2p::sam::PORT_SAM31);
