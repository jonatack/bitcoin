...
public:
     ...
     */
    std::vector<CAddrInfo> GetAddresses(size_t max_addresses, size_t max_pct, std::optional<Network> network) const;
    /**
     ...
     */
    std::vector<CAddrInfo> GetAddresses(CNode& requestor, size_t max_addresses, size_t max_pct);
...
private:
    ...
    struct CachedAddrResponse {
        std::vector<CAddrInfo> m_addrs_response_cache;
